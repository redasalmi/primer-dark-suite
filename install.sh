...
usage() {
    cat <<'EOF'
Usage: ./install.sh [--apply] [--konsole] [--ghostty] [--herdr] [--pi] [--zed] [--cursor] [--fastfetch] [--bat] [--btop] [--fish] [--gtk]
...
Use --konsole, --ghostty, --herdr, --pi, --zed, --cursor, --fastfetch, --bat, --btop, --fish, or --gtk to additionally install those application themes.
EOF
}
